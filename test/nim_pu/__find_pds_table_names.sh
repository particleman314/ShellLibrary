...
answer=$( __find_pds_table_names )
RC=$?
assert_empty "${answer}"
assert_failure "${RC}"

answer=$( __find_pds_table_names 'no_real_file' )
RC=$?
assert_empty "${answer}"
assert_failure "${RC}"

answer=$( __find_pds_table_names "${filename}" )
RC=$?
assert_not_empty "${answer}"
assert_equals 'spooler_capabilities' "${answer}"
